...
from serial.serialutil import (PortNotOpenError, SerialBase, SerialException,
                               SerialTimeoutException, Timeout, to_bytes)
    ...
    class PlatformSpecific(PlatformSpecificBase):
        ...
        def _set_special_baudrate(self, baudrate):
            ...
            try:
                ...
                raise ValueError(
                    "Failed to set custom baud rate ({}): {}".format(baudrate, e)
                )
...
class Serial(SerialBase, PlatformSpecific):
    ...
    def _reconfigure_port(self, force_update=False):
        ...
        try:
            ...
            termios.error
        ) as msg:  # if a port is nonexistent but has a /dev file, it'll fail here
