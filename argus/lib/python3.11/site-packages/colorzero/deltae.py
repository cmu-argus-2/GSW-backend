...
def cie1994(color1, color2, method):
    ...
    *method* can be either "cie1994g" for the "graphical" biases, or "cie1994t"
    ...
    SC = 1 + K1 * C1
    SH = 1 + K2 * C1
    return sqrt((dL / kL) ** 2 + (dC / SC) ** 2 + (dH2 / SH**2))
...
def ciede2000(color1, color2):
    ...
    C_ = (sqrt(color1.a**2 + color1.b**2) + sqrt(color2.a**2 + color2.b**2)) / 2
    ...
    h1 = 0.0 if color1.b == a1_prime == 0 else degrees(atan2(color1.b, a1_prime)) % 360
    h2 = 0.0 if color2.b == a2_prime == 0 else degrees(atan2(color2.b, a2_prime)) % 360
