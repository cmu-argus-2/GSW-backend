...
from typing import (TYPE_CHECKING, Any, Callable, Container, Iterable, Mapping,
...
def _fields_list_to_dict(
    ...
    if isinstance(fields, (abc.Sequence, abc.Set)):
        if not all(isinstance(field, str) for field in fields):
            raise TypeError(
                f"{option_name} must be a list of key names, each an instance of str"
            )
