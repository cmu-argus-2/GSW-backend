...
if dns._features.have("doq"):
    ...
    from dns.quic._asyncio import (AsyncioQuicConnection, AsyncioQuicManager,
                                   AsyncioQuicStream)
    from dns.quic._common import AsyncQuicConnection, AsyncQuicManager
    from dns.quic._sync import (SyncQuicConnection, SyncQuicManager,
                                SyncQuicStream)
    ...
    if dns._features.have("trio"):
        ...
        from dns.quic._trio import (  # pylint: disable=ungrouped-imports
            TrioQuicConnection, TrioQuicManager, TrioQuicStream)
