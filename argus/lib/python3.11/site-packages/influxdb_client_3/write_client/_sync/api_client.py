...
from influxdb_client_3.write_client import SigninService, SignoutService
...
from influxdb_client_3.write_client.rest import (_requires_create_user_session,
...
class ApiClient(object):
    ...
    def __del__(self):
        ...
        if (
            self.rest_client
            and self.rest_client.pool_manager
            and hasattr(self.rest_client.pool_manager, "clear")
        ):
    ...
    def _signin(self, resource_path: str):
        if _requires_create_user_session(
            self.configuration, self.cookie, resource_path
        ):
