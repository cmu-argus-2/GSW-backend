...
from pyarrow._compute import (  # noqa; Option classes; Functions; Udf; Expressions
    ArraySortOptions, AssumeTimezoneOptions, CastOptions, CountOptions,
    CumulativeOptions, CumulativeSumOptions, DayOfWeekOptions,
    DictionaryEncodeOptions, ElementWiseAggregateOptions, Expression,
    ExtractRegexOptions, FilterOptions, Function, FunctionOptions,
    FunctionRegistry, HashAggregateFunction, HashAggregateKernel, IndexOptions,
    JoinOptions, Kernel, ListFlattenOptions, ListSliceOptions,
    MakeStructOptions, MapLookupOptions, MatchSubstringOptions, ModeOptions,
    NullOptions, PadOptions, PairwiseOptions, PartitionNthOptions,
    QuantileOptions, RandomOptions, RankOptions, ReplaceSliceOptions,
    ReplaceSubstringOptions, RoundBinaryOptions, RoundOptions,
    RoundTemporalOptions, RoundToMultipleOptions, RunEndEncodeOptions,
    ScalarAggregateFunction, ScalarAggregateKernel, ScalarAggregateOptions,
    ScalarFunction, ScalarKernel, SelectKOptions, SetLookupOptions,
    SliceOptions, SortOptions, SplitOptions, SplitPatternOptions,
    StrftimeOptions, StrptimeOptions, StructFieldOptions, TakeOptions,
    TDigestOptions, TrimOptions, UdfContext, Utf8NormalizeOptions,
    VarianceOptions, VectorFunction, VectorKernel, WeekOptions, call_function,
    call_tabular_function, function_registry, get_function, list_functions,
    register_aggregate_function, register_scalar_function,
    register_tabular_function, register_vector_function)
    ...
    if args or kwargs:
        if options is not None:
            raise TypeError(
                ...
                "and additional arguments".format(name)
            )
    ...
    if options is not None:
        ...
        raise TypeError(
            "Function {!r} expected a {} parameter, got {}".format(
                name, options_class, type(options)
            )
        )
