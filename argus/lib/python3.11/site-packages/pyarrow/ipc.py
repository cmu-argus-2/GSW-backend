...
from pyarrow.lib import WriteStats  # noqa
from pyarrow.lib import (IpcReadOptions, IpcWriteOptions, Message,
                         MessageReader, MetadataVersion, ReadStats,
                         RecordBatchReader, _ReadPandasMixin,
                         get_record_batch_size, get_tensor_size, read_message,
...
def new_stream(sink, schema, *, use_legacy_format=None, options=None):
    return RecordBatchStreamWriter(
        sink, schema, use_legacy_format=use_legacy_format, options=options
    )
