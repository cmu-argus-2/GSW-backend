...
from mysql.opentelemetry.metrics import (Asynchronous, Counter, Histogram,
                                         Instrument, ObservableCounter,
                                         ObservableGauge,
                                         ObservableUpDownCounter, Synchronous,
                                         UpDownCounter)
from mysql.opentelemetry.sdk.metrics._internal.exponential_histogram.buckets import \
    Buckets
from mysql.opentelemetry.sdk.metrics._internal.exponential_histogram.mapping.exponent_mapping import \
    ExponentMapping
from mysql.opentelemetry.sdk.metrics._internal.exponential_histogram.mapping.logarithm_mapping import \
    LogarithmMapping
...
from mysql.opentelemetry.sdk.metrics._internal.point import \
    Buckets as BucketsPoint
from mysql.opentelemetry.sdk.metrics._internal.point import (
    ExponentialHistogramDataPoint, Gauge)
from mysql.opentelemetry.sdk.metrics._internal.point import \
    Histogram as HistogramPoint
from mysql.opentelemetry.sdk.metrics._internal.point import (
    HistogramDataPoint, NumberDataPoint, Sum)
...
class _SumAggregation(_Aggregation[Sum]):
    ...
    def collect(
        ...
        if aggregation_temporality is AggregationTemporality.DELTA:
            ...
            value = current_point.value + self._previous_point.value
            output_start_time_unix_nano = self._previous_point.start_time_unix_nano
...
class _ExponentialBucketHistogramAggregation(_Aggregation[HistogramPoint]):
    ...
    def __init__(
        ...
        # negative number range.  The value 160 is specified by mysql.OpenTelemetry.
