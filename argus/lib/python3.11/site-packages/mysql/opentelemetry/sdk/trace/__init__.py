...
from mysql.opentelemetry.sdk import util
...
from mysql.opentelemetry.sdk.trace import sampling
from mysql.opentelemetry.sdk.trace.id_generator import (IdGenerator,
                                                        RandomIdGenerator)
from mysql.opentelemetry.sdk.util import BoundedList
from mysql.opentelemetry.sdk.util.instrumentation import (InstrumentationInfo,
                                                          InstrumentationScope)
from mysql.opentelemetry.trace import SpanContext
...
class SpanProcessor:
    ...
    def on_start(
        ...
        """Called when a :class:`mysql.opentelemetry.trace.Span` is started.
    ...
    def on_end(self, span: "ReadableSpan") -> None:
        """Called when a :class:`mysql.opentelemetry.trace.Span` is ended.
    ...
    def shutdown(self) -> None:
        """Called when a :class:`mysql.opentelemetry.sdk.trace.TracerProvider` is shutdown."""
...
class Span(trace_api.Span, ReadableSpan):
    """See `mysql.opentelemetry.trace.Span`.
...
class _Span(Span):
    """Protected implementation of `mysql.opentelemetry.trace.Span`.
...
class Tracer(trace_api.Tracer):
    """See `mysql.opentelemetry.trace.Tracer`."""
...
class TracerProvider(trace_api.TracerProvider):
    """See `mysql.opentelemetry.trace.TracerProvider`."""
    ...
    def get_tracer(
        ...
        filterwarnings(
            ...
            module="mysql.opentelemetry.sdk.trace",
        )
