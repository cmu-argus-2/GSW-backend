...
from mysql.opentelemetry.trace.propagation import (_SPAN_KEY, get_current_span,
                                                   set_span_in_context)
from mysql.opentelemetry.trace.span import (DEFAULT_TRACE_OPTIONS,
                                            DEFAULT_TRACE_STATE, INVALID_SPAN,
                                            INVALID_SPAN_CONTEXT,
                                            INVALID_SPAN_ID, INVALID_TRACE_ID,
                                            NonRecordingSpan, Span,
                                            SpanContext, TraceFlags,
                                            TraceState, format_span_id,
                                            format_trace_id)
