...
from .types import (CextEofPacketType, CextResultType, DescriptionType,
                    ParamsSequenceOrDictType, ParamsSequenceType, RowItemType,
                    RowType, StrOrBytes, WarningType)

# pylint: enable=import-error,no-name-in-module
# isort: split

from .abstracts import (NAMED_TUPLE_CACHE, CMySQLPrepStmt,
                        MySQLConnectionAbstract, MySQLCursorAbstract)
from .cursor import (RE_PY_PARAM, RE_SQL_COMMENT, RE_SQL_FIND_PARAM,
                     RE_SQL_INSERT_STMT, RE_SQL_INSERT_VALUES,
                     RE_SQL_ON_DUPLICATE, RE_SQL_PYTHON_CAPTURE_PARAM_NAME,
