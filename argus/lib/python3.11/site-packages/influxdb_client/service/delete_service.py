...
class DeleteService(_BaseService):
    ...
    def post_delete(self, delete_predicate_request, **kwargs):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.post_delete_with_http_info(
                delete_predicate_request, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_delete_with_http_info(
                delete_predicate_request, **kwargs
            )  # noqa: E501
            return data

    def post_delete_with_http_info(
        self, delete_predicate_request, **kwargs
    ):  # noqa: E501,D401,D403
        """Delete data.
    ...
    def _post_delete_prepare(
        ...
        if (
            "delete_predicate_request" not in local_var_params
            or local_var_params["delete_predicate_request"] is None
        ):
            raise ValueError(
                "Missing the required parameter `delete_predicate_request` when calling `post_delete`"
            )  # noqa: E501
