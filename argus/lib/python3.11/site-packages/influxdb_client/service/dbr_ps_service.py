...
class DBRPsService(_BaseService):
    ...
    def _delete_dbrpid_prepare(self, dbrp_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if "dbrp_id" not in local_var_params or local_var_params["dbrp_id"] is None:
            raise ValueError(
                "Missing the required parameter `dbrp_id` when calling `delete_dbrpid`"
            )  # noqa: E501
    ...
    def _get_dbr_ps_prepare(self, **kwargs):  # noqa: E501,D401,D403
        ...
        if "bucket_id" in local_var_params:
            query_params.append(
                ("bucketID", local_var_params["bucket_id"])
            )  # noqa: E501
    ...
    def _get_dbr_ps_id_prepare(self, dbrp_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if "dbrp_id" not in local_var_params or local_var_params["dbrp_id"] is None:
            raise ValueError(
                "Missing the required parameter `dbrp_id` when calling `get_dbr_ps_id`"
            )  # noqa: E501
    ...
    def patch_dbrpid(self, dbrp_id, dbrp_update, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.patch_dbrpid_with_http_info(
                dbrp_id, dbrp_update, **kwargs
            )  # noqa: E501
        else:
            (data) = self.patch_dbrpid_with_http_info(
                dbrp_id, dbrp_update, **kwargs
            )  # noqa: E501
            return data

    def patch_dbrpid_with_http_info(
        self, dbrp_id, dbrp_update, **kwargs
    ):  # noqa: E501,D401,D403
        """Update a database retention policy mapping.
    ...
    def _patch_dbrpid_prepare(
        ...
        if "dbrp_id" not in local_var_params or local_var_params["dbrp_id"] is None:
            raise ValueError(
                "Missing the required parameter `dbrp_id` when calling `patch_dbrpid`"
            )  # noqa: E501
        # verify the required parameter 'dbrp_update' is set
        if (
            "dbrp_update" not in local_var_params
            or local_var_params["dbrp_update"] is None
        ):
            raise ValueError(
                "Missing the required parameter `dbrp_update` when calling `patch_dbrpid`"
            )  # noqa: E501
    ...
    def _post_dbrp_prepare(self, dbrp_create, **kwargs):  # noqa: E501,D401,D403
        ...
        if (
            "dbrp_create" not in local_var_params
            or local_var_params["dbrp_create"] is None
        ):
            raise ValueError(
                "Missing the required parameter `dbrp_create` when calling `post_dbrp`"
            )  # noqa: E501
