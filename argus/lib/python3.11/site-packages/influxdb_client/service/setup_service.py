...
class SetupService(_BaseService):
    ...
    def post_setup(self, onboarding_request, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_setup_with_http_info(
                onboarding_request, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_setup_with_http_info(
                onboarding_request, **kwargs
            )  # noqa: E501
            return data

    def post_setup_with_http_info(
        self, onboarding_request, **kwargs
    ):  # noqa: E501,D401,D403
        """Set up initial user, org and bucket.
    ...
    def _post_setup_prepare(self, onboarding_request, **kwargs):  # noqa: E501,D401,D403
        ...
        if (
            "onboarding_request" not in local_var_params
            or local_var_params["onboarding_request"] is None
        ):
            raise ValueError(
                "Missing the required parameter `onboarding_request` when calling `post_setup`"
            )  # noqa: E501
