...
class LabelsService(_BaseService):
    ...
    def delete_labels_id(self, label_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.delete_labels_id_with_http_info(
                label_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.delete_labels_id_with_http_info(
                label_id, **kwargs
            )  # noqa: E501
            return data

    def delete_labels_id_with_http_info(
        self, label_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Delete a label.
    ...
    def _delete_labels_id_prepare(self, label_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if "label_id" not in local_var_params or local_var_params["label_id"] is None:
            raise ValueError(
                "Missing the required parameter `label_id` when calling `delete_labels_id`"
            )  # noqa: E501
    ...
    def _get_labels_id_prepare(self, label_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if "label_id" not in local_var_params or local_var_params["label_id"] is None:
            raise ValueError(
                "Missing the required parameter `label_id` when calling `get_labels_id`"
            )  # noqa: E501
    ...
    def patch_labels_id(self, label_id, label_update, **kwargs):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.patch_labels_id_with_http_info(
                label_id, label_update, **kwargs
            )  # noqa: E501
        else:
            (data) = self.patch_labels_id_with_http_info(
                label_id, label_update, **kwargs
            )  # noqa: E501
            return data

    def patch_labels_id_with_http_info(
        self, label_id, label_update, **kwargs
    ):  # noqa: E501,D401,D403
        """Update a label.
    ...
    async def patch_labels_id_async(
        self, label_id, label_update, **kwargs
    ):  # noqa: E501,D401,D403
        """Update a label.
    ...
    def _patch_labels_id_prepare(
        ...
        if "label_id" not in local_var_params or local_var_params["label_id"] is None:
            raise ValueError(
                "Missing the required parameter `label_id` when calling `patch_labels_id`"
            )  # noqa: E501
        # verify the required parameter 'label_update' is set
        if (
            "label_update" not in local_var_params
            or local_var_params["label_update"] is None
        ):
            raise ValueError(
                "Missing the required parameter `label_update` when calling `patch_labels_id`"
            )  # noqa: E501
    ...
    def post_labels(self, label_create_request, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_labels_with_http_info(
                label_create_request, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_labels_with_http_info(
                label_create_request, **kwargs
            )  # noqa: E501
            return data

    def post_labels_with_http_info(
        self, label_create_request, **kwargs
    ):  # noqa: E501,D401,D403
        """Create a label.
    ...
    def _post_labels_prepare(
        ...
        if (
            ...
            raise ValueError(
                "Missing the required parameter `label_create_request` when calling `post_labels`"
            )  # noqa: E501
