...
class WriteService(_BaseService):
    ...
    def post_write(self, org, bucket, body, **kwargs):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.post_write_with_http_info(
                org, bucket, body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_write_with_http_info(
                org, bucket, body, **kwargs
            )  # noqa: E501
            return data

    def post_write_with_http_info(
        self, org, bucket, body, **kwargs
    ):  # noqa: E501,D401,D403
        """Write data.
    ...
    def _post_write_prepare(self, org, bucket, body, **kwargs):  # noqa: E501,D401,D403
        ...
        if "org" not in local_var_params or local_var_params["org"] is None:
            raise ValueError(
                "Missing the required parameter `org` when calling `post_write`"
            )  # noqa: E501
        # verify the required parameter 'bucket' is set
        if "bucket" not in local_var_params or local_var_params["bucket"] is None:
            raise ValueError(
                "Missing the required parameter `bucket` when calling `post_write`"
            )  # noqa: E501
        # verify the required parameter 'body' is set
        if "body" not in local_var_params or local_var_params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `post_write`"
            )  # noqa: E501
