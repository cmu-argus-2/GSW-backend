...
class QueryService(_BaseService):
    ...
    def _get_query_suggestions_prepare(self, **kwargs):  # noqa: E501,D401,D403
        ...
        self._check_operation_params(
            "get_query_suggestions", all_params, local_var_params
        )
    ...
    def get_query_suggestions_name(self, name, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_query_suggestions_name_with_http_info(
                name, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_query_suggestions_name_with_http_info(
                name, **kwargs
            )  # noqa: E501
            return data
    ...
    async def get_query_suggestions_name_async(
        self, name, **kwargs
    ):  # noqa: E501,D401,D403
        """Retrieve a query suggestion for a branching suggestion.
    ...
    def _get_query_suggestions_name_prepare(
        self, name, **kwargs
    ):  # noqa: E501,D401,D403
        local_var_params = locals()
        ...
        self._check_operation_params(
            "get_query_suggestions_name", all_params, local_var_params
        )
        # verify the required parameter 'name' is set
        if "name" not in local_var_params or local_var_params["name"] is None:
            raise ValueError(
                "Missing the required parameter `name` when calling `get_query_suggestions_name`"
            )  # noqa: E501
    ...
    def post_query_analyze_with_http_info(self, **kwargs):  # noqa: E501,D401,D403
        ...
        (
            ...
            header_params,
            body_params,
        ) = self._post_query_analyze_prepare(
            **kwargs
        )  # noqa: E501
