...
class RulesService(_BaseService):
    ...
    def get_notification_rules_id_query(
        ...
        if kwargs.get("async_req"):
            return self.get_notification_rules_id_query_with_http_info(
                rule_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_notification_rules_id_query_with_http_info(
                rule_id, **kwargs
            )  # noqa: E501
            return data

    def get_notification_rules_id_query_with_http_info(
        self, rule_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Retrieve a notification rule query.
    ...
    async def get_notification_rules_id_query_async(
        self, rule_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Retrieve a notification rule query.
    ...
    def _get_notification_rules_id_query_prepare(
        self, rule_id, **kwargs
    ):  # noqa: E501,D401,D403
        ...
        self._check_operation_params(
            "get_notification_rules_id_query", all_params, local_var_params
        )
        # verify the required parameter 'rule_id' is set
        if "rule_id" not in local_var_params or local_var_params["rule_id"] is None:
            raise ValueError(
                "Missing the required parameter `rule_id` when calling `get_notification_rules_id_query`"
            )  # noqa: E501
