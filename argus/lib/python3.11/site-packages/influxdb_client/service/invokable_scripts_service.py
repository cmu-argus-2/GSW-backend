...
class InvokableScriptsService(_BaseService):
    ...
    def delete_scripts_id(self, script_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.delete_scripts_id_with_http_info(
                script_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.delete_scripts_id_with_http_info(
                script_id, **kwargs
            )  # noqa: E501
            return data

    def delete_scripts_id_with_http_info(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Delete a script.
        ...
        if not self._is_cloud_instance():
            ...
            CloudOnlyWarning.print_warning(
        ...
        (
            ...
            header_params,
            body_params,
        ) = self._delete_scripts_id_prepare(
            script_id, **kwargs
        )  # noqa: E501
    ...
    async def delete_scripts_id_async(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Delete a script.
    ...
    def _delete_scripts_id_prepare(self, script_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if "script_id" not in local_var_params or local_var_params["script_id"] is None:
            raise ValueError(
                "Missing the required parameter `script_id` when calling `delete_scripts_id`"
            )  # noqa: E501
    ...
    def _get_scripts_prepare(self, **kwargs):  # noqa: E501,D401,D403
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for parameter `offset` when calling `get_scripts`, must be a value greater than or equal to `0`"
            )  # noqa: E501
        if (
            "limit" in local_var_params and local_var_params["limit"] > 500
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for parameter `limit` when calling `get_scripts`, must be a value less than or equal to `500`"
            )  # noqa: E501
        if "limit" in local_var_params and local_var_params["limit"] < 0:  # noqa: E501
            raise ValueError(
                "Invalid value for parameter `limit` when calling `get_scripts`, must be a value greater than or equal to `0`"
            )  # noqa: E501
        path_params = {}
    ...
    def get_scripts_id(self, script_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.get_scripts_id_with_http_info(
                script_id, **kwargs
            )  # noqa: E501
            return data

    def get_scripts_id_with_http_info(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Retrieve a script.
    ...
    def _get_scripts_id_prepare(self, script_id, **kwargs):  # noqa: E501,D401,D403
        ...
        if "script_id" not in local_var_params or local_var_params["script_id"] is None:
            raise ValueError(
                "Missing the required parameter `script_id` when calling `get_scripts_id`"
            )  # noqa: E501
    ...
    def get_scripts_id_params(self, script_id, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_scripts_id_params_with_http_info(
                script_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_scripts_id_params_with_http_info(
                script_id, **kwargs
            )  # noqa: E501
            return data

    def get_scripts_id_params_with_http_info(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Find script parameters..
        ...
        (
            ...
            header_params,
            body_params,
        ) = self._get_scripts_id_params_prepare(
            script_id, **kwargs
        )  # noqa: E501
    ...
    async def get_scripts_id_params_async(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Find script parameters..
    ...
    def _get_scripts_id_params_prepare(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        local_var_params = locals()
        ...
        self._check_operation_params(
            "get_scripts_id_params", all_params, local_var_params
        )
        # verify the required parameter 'script_id' is set
        if "script_id" not in local_var_params or local_var_params["script_id"] is None:
            raise ValueError(
                "Missing the required parameter `script_id` when calling `get_scripts_id_params`"
            )  # noqa: E501
    ...
    def patch_scripts_id(
        self, script_id, script_update_request, **kwargs
    ):  # noqa: E501,D401,D403
        """Update a script.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.patch_scripts_id_with_http_info(
                script_id, script_update_request, **kwargs
            )  # noqa: E501
        else:
            (data) = self.patch_scripts_id_with_http_info(
                script_id, script_update_request, **kwargs
            )  # noqa: E501
            return data

    def patch_scripts_id_with_http_info(
        self, script_id, script_update_request, **kwargs
    ):  # noqa: E501,D401,D403
        """Update a script.
    ...
    async def patch_scripts_id_async(
        self, script_id, script_update_request, **kwargs
    ):  # noqa: E501,D401,D403
        """Update a script.
    ...
    def _patch_scripts_id_prepare(
        ...
        if "script_id" not in local_var_params or local_var_params["script_id"] is None:
            raise ValueError(
                "Missing the required parameter `script_id` when calling `patch_scripts_id`"
            )  # noqa: E501
        # verify the required parameter 'script_update_request' is set
        if (
            "script_update_request" not in local_var_params
            or local_var_params["script_update_request"] is None
        ):
            raise ValueError(
                "Missing the required parameter `script_update_request` when calling `patch_scripts_id`"
            )  # noqa: E501
    ...
    def post_scripts(self, script_create_request, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_scripts_with_http_info(
                script_create_request, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_scripts_with_http_info(
                script_create_request, **kwargs
            )  # noqa: E501
            return data

    def post_scripts_with_http_info(
        self, script_create_request, **kwargs
    ):  # noqa: E501,D401,D403
        """Create a script.
    ...
    def _post_scripts_prepare(
        ...
        if (
            "script_create_request" not in local_var_params
            or local_var_params["script_create_request"] is None
        ):
            raise ValueError(
                "Missing the required parameter `script_create_request` when calling `post_scripts`"
            )  # noqa: E501
    ...
    def post_scripts_id_invoke(self, script_id, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_scripts_id_invoke_with_http_info(
                script_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_scripts_id_invoke_with_http_info(
                script_id, **kwargs
            )  # noqa: E501
            return data

    def post_scripts_id_invoke_with_http_info(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Invoke a script.
    ...
    async def post_scripts_id_invoke_async(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Invoke a script.
    ...
    def _post_scripts_id_invoke_prepare(
        self, script_id, **kwargs
    ):  # noqa: E501,D401,D403
        local_var_params = locals()
        ...
        self._check_operation_params(
            "post_scripts_id_invoke", all_params, local_var_params
        )
        # verify the required parameter 'script_id' is set
        if "script_id" not in local_var_params or local_var_params["script_id"] is None:
            raise ValueError(
                "Missing the required parameter `script_id` when calling `post_scripts_id_invoke`"
            )  # noqa: E501
