...
class BackupService(_BaseService):
    ...
    def get_backup_metadata_with_http_info(self, **kwargs):  # noqa: E501,D401,D403
        ...
        (
            ...
            header_params,
            body_params,
        ) = self._get_backup_metadata_prepare(
            **kwargs
        )  # noqa: E501
    ...
    def _get_backup_metadata_prepare(self, **kwargs):  # noqa: E501,D401,D403
        ...
        self._check_operation_params(
            "get_backup_metadata", all_params, local_var_params
        )
    ...
    def get_backup_shard_id(self, shard_id, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_backup_shard_id_with_http_info(
                shard_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_backup_shard_id_with_http_info(
                shard_id, **kwargs
            )  # noqa: E501
            return data

    def get_backup_shard_id_with_http_info(
        self, shard_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Download snapshot of all TSM data in a shard.
    ...
    async def get_backup_shard_id_async(
        self, shard_id, **kwargs
    ):  # noqa: E501,D401,D403
        """Download snapshot of all TSM data in a shard.
    ...
    def _get_backup_shard_id_prepare(self, shard_id, **kwargs):  # noqa: E501,D401,D403
        ...
        self._check_operation_params(
            "get_backup_shard_id", all_params, local_var_params
        )
        # verify the required parameter 'shard_id' is set
        if "shard_id" not in local_var_params or local_var_params["shard_id"] is None:
            raise ValueError(
                "Missing the required parameter `shard_id` when calling `get_backup_shard_id`"
            )  # noqa: E501
