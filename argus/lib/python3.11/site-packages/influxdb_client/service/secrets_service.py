...
class SecretsService(_BaseService):
    ...
    def delete_orgs_id_secrets_id(
        self, org_id, secret_id, **kwargs
    ):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.delete_orgs_id_secrets_id_with_http_info(
                org_id, secret_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.delete_orgs_id_secrets_id_with_http_info(
                org_id, secret_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def _delete_orgs_id_secrets_id_prepare(
        ...
        self._check_operation_params(
            "delete_orgs_id_secrets_id", all_params, local_var_params
        )
        # verify the required parameter 'org_id' is set
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            raise ValueError(
                "Missing the required parameter `org_id` when calling `delete_orgs_id_secrets_id`"
            )  # noqa: E501
        # verify the required parameter 'secret_id' is set
        if "secret_id" not in local_var_params or local_var_params["secret_id"] is None:
            raise ValueError(
                "Missing the required parameter `secret_id` when calling `delete_orgs_id_secrets_id`"
            )  # noqa: E501
    ...
    def get_orgs_id_secrets(self, org_id, **kwargs):  # noqa: E501,D401,D403
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_orgs_id_secrets_with_http_info(
                org_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_orgs_id_secrets_with_http_info(
                org_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def _get_orgs_id_secrets_prepare(self, org_id, **kwargs):  # noqa: E501,D401,D403
        ...
        self._check_operation_params(
            "get_orgs_id_secrets", all_params, local_var_params
        )
        # verify the required parameter 'org_id' is set
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            raise ValueError(
                "Missing the required parameter `org_id` when calling `get_orgs_id_secrets`"
            )  # noqa: E501
    ...
    def patch_orgs_id_secrets(
        self, org_id, request_body, **kwargs
    ):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.patch_orgs_id_secrets_with_http_info(
                org_id, request_body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.patch_orgs_id_secrets_with_http_info(
                org_id, request_body, **kwargs
            )  # noqa: E501
            return data
    ...
    def _patch_orgs_id_secrets_prepare(
        ...
        self._check_operation_params(
            "patch_orgs_id_secrets", all_params, local_var_params
        )
        # verify the required parameter 'org_id' is set
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            raise ValueError(
                "Missing the required parameter `org_id` when calling `patch_orgs_id_secrets`"
            )  # noqa: E501
    ...
    def post_orgs_id_secrets(
        self, org_id, secret_keys, **kwargs
    ):  # noqa: E501,D401,D403
        ...
        if kwargs.get("async_req"):
            return self.post_orgs_id_secrets_with_http_info(
                org_id, secret_keys, **kwargs
            )  # noqa: E501
        else:
            (data) = self.post_orgs_id_secrets_with_http_info(
                org_id, secret_keys, **kwargs
            )  # noqa: E501
            return data
    ...
    def _post_orgs_id_secrets_prepare(
        self, org_id, secret_keys, **kwargs
    ):  # noqa: E501,D401,D403
        local_var_params = locals()
        ...
        self._check_operation_params(
            "post_orgs_id_secrets", all_params, local_var_params
        )
        # verify the required parameter 'org_id' is set
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            raise ValueError(
                "Missing the required parameter `org_id` when calling `post_orgs_id_secrets`"
            )  # noqa: E501
        # verify the required parameter 'secret_keys' is set
        if (
            "secret_keys" not in local_var_params
            or local_var_params["secret_keys"] is None
        ):
            raise ValueError(
                "Missing the required parameter `secret_keys` when calling `post_orgs_id_secrets`"
            )  # noqa: E501
