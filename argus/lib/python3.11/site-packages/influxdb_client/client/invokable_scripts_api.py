...
from influxdb_client import (InvokableScriptsService, Script,
                             ScriptCreateRequest, ScriptInvocationParams,
                             ScriptUpdateRequest)
...
class InvokableScriptsApi(_BaseQueryApi):
    ...
    def __init__(self, influxdb_client):
        ...
        self._invokable_scripts_service = InvokableScriptsService(
    ...
    def create_script(self, create_request: ScriptCreateRequest) -> Script:
        ...
        """
        return self._invokable_scripts_service.post_scripts(
            script_create_request=create_request
        )

    def update_script(
        self, script_id: str, update_request: ScriptUpdateRequest
    ) -> Script:
        """Update a script.
        ...
        :return: The updated.
        """
        return self._invokable_scripts_service.patch_scripts_id(
            script_id=script_id, script_update_request=update_request
        )
    ...
    def invoke_script(self, script_id: str, params: dict = None) -> TableList:
        ...
        """  # noqa: E501
        response = self._invokable_scripts_service.post_scripts_id_invoke(
            script_id=script_id,
    ...
    def invoke_script_stream(
        self, script_id: str, params: dict = None
        ...
        return self._to_flux_record_stream(
            response,
            query_options=None,
            response_metadata_mode=FluxResponseMetadataMode.only_names,
        )
    ...
    def invoke_script_data_frame(
        ...
        """  # noqa: E501
        _generator = self.invoke_script_data_frame_stream(
            script_id=script_id, params=params, data_frame_index=data_frame_index
        )
    ...
    def invoke_script_data_frame_stream(
        ...
        return self._to_data_frame_stream(
            data_frame_index,
            response,
            query_options=None,
            response_metadata_mode=FluxResponseMetadataMode.only_names,
