...
from influxdb_client import (Label, LabelCreateRequest, LabelsService,
                             LabelUpdate)
...
class LabelsApi(object):
    ...
    def create_label(
        self, name: str, org_id: str, properties: Dict[str, str] = None
    ) -> Label:
        """
        Create a new label.
        ...
        """
        label_request = LabelCreateRequest(
            org_id=org_id, name=name, properties=properties
        )
    ...
    def update_label(self, label: Label):
        ...
        return self._service.patch_labels_id(
            label_id=label.id, label_update=label_update
        ).label
