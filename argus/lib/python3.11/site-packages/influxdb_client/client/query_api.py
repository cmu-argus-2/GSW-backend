...
class QueryOptions(object):
    ...
    def __init__(
        self, profilers: List[str] = None, profiler_callback: Callable = None
    ) -> None:
        """
...
class QueryApi(_BaseQueryApi):
    ...
    def query_csv(
        ...
        query: str,
        org=None,
        dialect: Dialect = _BaseQueryApi.default_dialect,
        params: dict = None,
    ) -> CSVIterator:
        """
        ...
        response = self._query_api.post_query(
            org=org,
            query=self._create_query(query, dialect, params),
            async_req=False,
    ...
    def query_data_frame(
        ...
        """  # noqa: E501
        _generator = self.query_data_frame_stream(
            query,
            org=org,
