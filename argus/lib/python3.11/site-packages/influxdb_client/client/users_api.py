...
from influxdb_client import (PasswordResetBody, User, UserResponse, Users,
                             UsersService)
...
class UsersApi(object):
    ...
    def update_password(
        self, user: Union[str, User, UserResponse], password: str
    ) -> None:
        """Update a password.
        ...
        return self._service.post_users_id_password(
            user_id=user_id, password_reset_body=PasswordResetBody(password)
        )
