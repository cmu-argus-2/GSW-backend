...
from influxdb_client import (AddResourceMemberRequestBody, LabelMapping,
                             LabelResponse, LogEvent, Run, RunManually, Task,
                             TaskCreateRequest, TasksService,
                             TaskUpdateRequest)
...
class TasksApi(object):
    ...
    def find_tasks_iter(self, **kwargs):
        ...
        """
        return _Paginated(
            self._service.get_tasks, lambda response: response.tasks
        ).find_iter(**kwargs)

    def create_task(
        self, task: Task = None, task_create_request: TaskCreateRequest = None
    ) -> Task:
        """Create a new task."""
    ...
    def _create_task(name: str, flux: str, every, cron, org_id: str) -> Task:
        ...
        flux_with_options = '{} \n\noption task = {{name: "{}", {}}}'.format(
            flux, name, repetition
        )
    ...
    def create_task_cron(self, name: str, flux: str, cron: str, org_id: str) -> Task:
        ...
        task = self._create_task(
            name=name, flux=flux, cron=cron, org_id=org_id, every=None
        )
        return self.create_task(task)
    ...
    def update_task_request(
        ...
        """Update a task."""
        return self._service.patch_tasks_id(
            task_id=task_id, task_update_request=task_update_request
        )
    ...
    def add_member(self, member_id, task_id):
        ...
        return self._service.post_tasks_id_members(
            task_id=task_id, add_resource_member_request_body=user
        )

    def delete_member(self, member_id, task_id):
        """Remove a member from a task."""
        return self._service.delete_tasks_id_members_id(
            user_id=member_id, task_id=task_id
        )
    ...
    def add_owner(self, owner_id, task_id):
        ...
        return self._service.post_tasks_id_owners(
            task_id=task_id, add_resource_member_request_body=user
        )

    def delete_owner(self, owner_id, task_id):
        """Remove an owner from a task."""
        return self._service.delete_tasks_id_owners_id(
    ...
    def get_run_logs(self, task_id: str, run_id: str) -> List["LogEvent"]:
        ...
        return self._service.get_tasks_id_runs_id_logs(
