...
from influxdb_client.rest import ApiException, _UTF_8_encoding
...
class QueryApiAsync(_BaseQueryApi):
    ...
    async def query(self, query: str, org=None, params: dict = None) -> TableList:
        ...
        response = await self._post_query(
            org=org, query=self._create_query(query, self.default_dialect, params)
        )

        return await self._to_tables_async(
            response, query_options=self._get_query_options()
        )

    async def query_stream(
        self, query: str, org=None, params: dict = None
        ...
        return await self._to_flux_record_stream_async(
            response, query_options=self._get_query_options()
        )
    ...
    async def query_data_frame(
        ...
        """  # noqa: E501
        _generator = await self.query_data_frame_stream(
            query,
            org=org,
    ...
    async def query_data_frame_stream(
        ...
        response = await self._post_query(
            ...
            query=self._create_query(
                query, self.default_dialect, params, dataframe_query=True
            ),
        )

        return await self._to_data_frame_stream_async(
            data_frame_index=data_frame_index,
            response=response,
    ...
    async def query_raw(
        ...
        query: str,
        org=None,
        dialect=_BaseQueryApi.default_dialect,
        params: dict = None,
    ):
        """
