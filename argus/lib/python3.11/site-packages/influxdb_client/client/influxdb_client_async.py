...
class InfluxDBClientAsync(_BaseClient):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            http_client_logger="aiohttp.client",
            **kwargs,
        )
        ...
        self.api_client = ApiClientAsync(
    ...
    def from_config_file(
        ...
        """
        return InfluxDBClientAsync._from_config_file(
    ...
    def from_env_properties(cls, debug=None, enable_gzip=False, **kwargs):
        ...
        Supported environment properties:
            ...
            - INFLUXDB_V2_TAG
        """
        return InfluxDBClientAsync._from_env_properties(
