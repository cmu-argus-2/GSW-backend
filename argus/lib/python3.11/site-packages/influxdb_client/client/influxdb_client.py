...
from influxdb_client import (HealthCheck, HealthService, InvokableScriptsApi,
                             PingService, Ready, ReadyService)
...
from influxdb_client.client.write_api import (PointSettings, WriteApi,
                                              WriteOptions)
...
class InfluxDBClient(_BaseClient):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.api_client = ApiClient(
            ...
            header_value=self.auth_header_value,
    ...
    def from_config_file(
        ...
        """
        return InfluxDBClient._from_config_file(
    ...
    def write_api(
        self, write_options=WriteOptions(), point_settings=PointSettings(), **kwargs
    ) -> WriteApi:
        """
    ...
    def health(self) -> HealthCheck:
        ...
        """
        warnings.warn(
            "This method is deprecated. Call 'ping()' instead.", DeprecationWarning
        )
