...
class NotificationEndpoint(object):
    ...
    """
    openapi_types = {"type": "NotificationEndpointType"}
    ...
    @property
    def type(self):
        """Get the type of this NotificationEndpoint.

        :return: The type of this NotificationEndpoint.
    ...
    @type.setter
    def type(self, type):
        """Set the type of this NotificationEndpoint.

        :param type: The type of this NotificationEndpoint.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotificationEndpoint):
            return False
