...
class RetentionPolicyManifest(object):
    ...
    def replica_n(self, replica_n):
        ...
        if replica_n is None:
            raise ValueError(
                "Invalid value for `replica_n`, must not be `None`"
            )  # noqa: E501
    ...
    def shard_group_duration(self, shard_group_duration):
        ...
        if shard_group_duration is None:
            raise ValueError(
                "Invalid value for `shard_group_duration`, must not be `None`"
            )  # noqa: E501
    ...
    def shard_groups(self, shard_groups):
        ...
        if shard_groups is None:
            raise ValueError(
                "Invalid value for `shard_groups`, must not be `None`"
            )  # noqa: E501
    ...
    def subscriptions(self, subscriptions):
        ...
        if subscriptions is None:
            raise ValueError(
                "Invalid value for `subscriptions`, must not be `None`"
            )  # noqa: E501
