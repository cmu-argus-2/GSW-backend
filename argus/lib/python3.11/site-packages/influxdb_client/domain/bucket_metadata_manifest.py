...
class BucketMetadataManifest(object):
    ...
    def organization_id(self, organization_id):
        ...
        if organization_id is None:
            raise ValueError(
                "Invalid value for `organization_id`, must not be `None`"
            )  # noqa: E501
    ...
    def organization_name(self, organization_name):
        ...
        if organization_name is None:
            raise ValueError(
                "Invalid value for `organization_name`, must not be `None`"
            )  # noqa: E501
    ...
    def bucket_id(self, bucket_id):
        ...
        if bucket_id is None:
            raise ValueError(
                "Invalid value for `bucket_id`, must not be `None`"
            )  # noqa: E501
    ...
    def bucket_name(self, bucket_name):
        ...
        if bucket_name is None:
            raise ValueError(
                "Invalid value for `bucket_name`, must not be `None`"
            )  # noqa: E501
    ...
    def default_retention_policy(self, default_retention_policy):
        ...
        if default_retention_policy is None:
            raise ValueError(
                "Invalid value for `default_retention_policy`, must not be `None`"
            )  # noqa: E501
    ...
    def retention_policies(self, retention_policies):
        ...
        if retention_policies is None:
            raise ValueError(
                "Invalid value for `retention_policies`, must not be `None`"
            )  # noqa: E501
