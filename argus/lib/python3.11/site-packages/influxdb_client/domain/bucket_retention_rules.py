...
class BucketRetentionRules(object):
    ...
    def __init__(
        self, type="expire", every_seconds=2592000, shard_group_duration_seconds=None
    ):  # noqa: E501,D401,D403
    ...
    def every_seconds(self, every_seconds):
        ...
        if every_seconds is None:
            raise ValueError(
                "Invalid value for `every_seconds`, must not be `None`"
            )  # noqa: E501
        if every_seconds is not None and every_seconds < 0:  # noqa: E501
            raise ValueError(
                "Invalid value for `every_seconds`, must be a value greater than or equal to `0`"
            )  # noqa: E501
