...
class LinePlusSingleStatProperties(ViewProperties):
    ...
    def adaptive_zoom_hide(self):
        """Get the adaptive_zoom_hide of this LinePlusSingleStatProperties.

        :return: The adaptive_zoom_hide of this LinePlusSingleStatProperties.
        :rtype: bool
        """  # noqa: E501
    ...
    def adaptive_zoom_hide(self, adaptive_zoom_hide):
        """Set the adaptive_zoom_hide of this LinePlusSingleStatProperties.
    ...
    def axes(self, axes):
        ...
        if axes is None:
            raise ValueError(
                "Invalid value for `axes`, must not be `None`"
            )  # noqa: E501
        self._axes = axes
    ...
    def prefix(self, prefix):
        ...
        if prefix is None:
            raise ValueError(
                "Invalid value for `prefix`, must not be `None`"
            )  # noqa: E501
        self._prefix = prefix
    ...
    def suffix(self, suffix):
        ...
        if suffix is None:
            raise ValueError(
                "Invalid value for `suffix`, must not be `None`"
            )  # noqa: E501
        self._suffix = suffix
    ...
    def decimal_places(self, decimal_places):
        ...
        if decimal_places is None:
            raise ValueError(
                "Invalid value for `decimal_places`, must not be `None`"
            )  # noqa: E501
