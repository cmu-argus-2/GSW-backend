...
class CreateDashboardRequest(object):
    ...
    """
    openapi_types = {"org_id": "str", "name": "str", "description": "str"}

    attribute_map = {"org_id": "orgID", "name": "name", "description": "description"}

    def __init__(
        self, org_id=None, name=None, description=None
    ):  # noqa: E501,D401,D403
