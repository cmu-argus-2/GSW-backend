...
class DeletePredicateRequest(object):
    ...
    """
    openapi_types = {"start": "datetime", "stop": "datetime", "predicate": "str"}

    attribute_map = {"start": "start", "stop": "stop", "predicate": "predicate"}
    ...
    def stop(self, stop):
        ...
        if stop is None:
            raise ValueError(
                "Invalid value for `stop`, must not be `None`"
            )  # noqa: E501
        self._stop = stop
