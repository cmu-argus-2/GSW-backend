...
class Dialect(object):
    ...
    def delimiter(self, delimiter):
        ...
        if delimiter is not None and len(delimiter) > 1:
            raise ValueError(
                "Invalid value for `delimiter`, length must be less than or equal to `1`"
            )  # noqa: E501
        if delimiter is not None and len(delimiter) < 1:
            raise ValueError(
                "Invalid value for `delimiter`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def annotations(self, annotations):
        ...
        if not set(annotations).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `annotations` [{0}], must be a subset of [{1}]".format(  # noqa: E501
                    ", ".join(
                        map(str, set(annotations) - set(allowed_values))
                    ),  # noqa: E501
    ...
    def comment_prefix(self, comment_prefix):
        ...
        if comment_prefix is not None and len(comment_prefix) > 1:
            raise ValueError(
                "Invalid value for `comment_prefix`, length must be less than or equal to `1`"
            )  # noqa: E501
        if comment_prefix is not None and len(comment_prefix) < 0:
            raise ValueError(
                "Invalid value for `comment_prefix`, length must be greater than or equal to `0`"
            )  # noqa: E501
