...
class SubscriptionManifest(object):
    ...
    """
    openapi_types = {"name": "str", "mode": "str", "destinations": "list[str]"}

    attribute_map = {"name": "name", "mode": "mode", "destinations": "destinations"}
    ...
    def mode(self, mode):
        ...
        if mode is None:
            raise ValueError(
                "Invalid value for `mode`, must not be `None`"
            )  # noqa: E501
        self._mode = mode
    ...
    def destinations(self, destinations):
        ...
        if destinations is None:
            raise ValueError(
                "Invalid value for `destinations`, must not be `None`"
            )  # noqa: E501
