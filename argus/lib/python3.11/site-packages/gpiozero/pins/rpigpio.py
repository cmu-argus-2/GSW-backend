...
from ..exc import (PinFixedPull, PinInvalidBounce, PinInvalidFunction,
                   PinInvalidPull, PinInvalidState, PinPWMFixedValue,
                   PinSetInput)
...
class RPiGPIOPin(LocalPiPin):
    ...
    def _set_function(self, value):
        ...
        if value in ("input", "output") and value in self.GPIO_FUNCTIONS:
            GPIO.setup(
                self._number, self.GPIO_FUNCTIONS[value], self.GPIO_PULL_UPS[self._pull]
            )
        else:
