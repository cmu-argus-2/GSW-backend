...
class LGPIOPin(LocalPiPin):
    ...
    GPIO_LINE_FLAGS_MASK = (
        ...
        | GPIO_IS_OPEN_DRAIN
        | GPIO_IS_OPEN_SOURCE
        | GPIO_IS_BIAS_PULL_UP
        | GPIO_IS_BIAS_PULL_DOWN
        | GPIO_IS_BIAS_DISABLE
    )
    ...
    def __init__(self, factory, info):
        ...
        lgpio.gpio_claim_input(self.factory._handle, self._number, lgpio.SET_PULL_NONE)
    ...
    def _set_bounce(self, value):
        ...
        lgpio.gpio_set_debounce_micros(self.factory._handle, self._number, value)
        self._bounce = value
    ...
    def _enable_event_detect(self):
        ...
        self._callback = lgpio.callback(
            self.factory._handle, self._number, self._edges, self._call_when_changed
        )
...
class LGPIOHardwareSPI(SPI):
    ...
    def _conflicts_with(self, other):
        return not (
            isinstance(other, LGPIOHardwareSPI)
