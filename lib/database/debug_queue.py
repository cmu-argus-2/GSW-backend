...
add_new_command({"id": MSG_ID.GS_CMD_FILE_METADATA, "args" : {"file_id": 1, "file_time": int(time.time())}})

# Sending TM commands
add_new_command({"id": MSG_ID.SAT_TM_STORAGE, "args" : {}})
add_new_command({"id": MSG_ID.SAT_TM_HAL, "args" : {}})
