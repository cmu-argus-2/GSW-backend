...
class TelemetryUnpacker:
    ...
    def unpack_tm_frame(self, msg):
        ...
        self._data_EPS[EPS_IDX.BATTERY_PACK_CURRENT] = unpack_signed_short_int(msg[23:25])
        self._data_EPS[EPS_IDX.BATTERY_PACK_VOLTAGE] = unpack_signed_short_int(msg[27:29])
        self._data_EPS[EPS_IDX.BATTERY_PACK_MIDPOINT_VOLTAGE] = unpack_signed_short_int(msg[29:31])
        ...
        self._data_EPS[EPS_IDX.JETSON_INPUT_VOLTAGE] = unpack_signed_short_int(msg[63:65])
        self._data_EPS[EPS_IDX.JETSON_INPUT_CURRENT] = unpack_signed_short_int(msg[65:67])

        self._data_EPS[EPS_IDX.RF_LDO_OUTPUT_VOLTAGE] = unpack_signed_short_int(msg[67:69])
        self._data_EPS[EPS_IDX.RF_LDO_OUTPUT_CURRENT] = unpack_signed_short_int(msg[69:71])
        ...
        self._data_EPS[EPS_IDX.XP_SOLAR_CHARGE_VOLTAGE] = unpack_signed_short_int(msg[75:77])
        self._data_EPS[EPS_IDX.XP_SOLAR_CHARGE_CURRENT] = unpack_signed_short_int(msg[77:79])
        self._data_EPS[EPS_IDX.XM_SOLAR_CHARGE_VOLTAGE] = unpack_signed_short_int(msg[79:81])
        self._data_EPS[EPS_IDX.XM_SOLAR_CHARGE_CURRENT] = unpack_signed_short_int(msg[81:83])

        self._data_EPS[EPS_IDX.YP_SOLAR_CHARGE_VOLTAGE] = unpack_signed_short_int(msg[83:85])
        self._data_EPS[EPS_IDX.YP_SOLAR_CHARGE_CURRENT] = unpack_signed_short_int(msg[85:87])
        self._data_EPS[EPS_IDX.YM_SOLAR_CHARGE_VOLTAGE] = unpack_signed_short_int(msg[87:89])
        self._data_EPS[EPS_IDX.YM_SOLAR_CHARGE_CURRENT] = unpack_signed_short_int(msg[89:91])

        self._data_EPS[EPS_IDX.ZP_SOLAR_CHARGE_VOLTAGE] = unpack_signed_short_int(msg[91:93])
        self._data_EPS[EPS_IDX.ZP_SOLAR_CHARGE_CURRENT] = unpack_signed_short_int(msg[93:95])
        self._data_EPS[EPS_IDX.ZM_SOLAR_CHARGE_VOLTAGE] = unpack_signed_short_int(msg[95:97])
        self._data_EPS[EPS_IDX.ZM_SOLAR_CHARGE_CURRENT] = unpack_signed_short_int(msg[97:99])
        ...
        self._data_ADCS[ADCS_IDX.SUN_VEC_X] = convert_fixed_point_to_float_hp(msg[125:129])
        self._data_ADCS[ADCS_IDX.SUN_VEC_Y] = convert_fixed_point_to_float_hp(msg[129:133])
        self._data_ADCS[ADCS_IDX.SUN_VEC_Z] = convert_fixed_point_to_float_hp(msg[133:137])
        ...
        self._data_ADCS[ADCS_IDX.COARSE_ATTITUDE_QW] = convert_fixed_point_to_float_hp(msg[162:166])
        self._data_ADCS[ADCS_IDX.COARSE_ATTITUDE_QX] = convert_fixed_point_to_float_hp(msg[166:170])
        self._data_ADCS[ADCS_IDX.COARSE_ATTITUDE_QY] = convert_fixed_point_to_float_hp(msg[170:174])
        self._data_ADCS[ADCS_IDX.COARSE_ATTITUDE_QZ] = convert_fixed_point_to_float_hp(msg[174:178])
